...
def pdf_to_text(pdf_path):
    ...
    print("\nProcessing pages...\n")
    for i, image in enumerate(tqdm(images, desc="OCR Progress", unit="page")):
    ...
    print(f"\n✅ Text extracted and saved as: {output_text_file}")
...
class PDFOCRApp(TkinterDnD.Tk):
    def __init__(self):
        ...
        browse_btn = tk.Button(self, text="Browse PDF", command=self.browse_file, font=("Arial", 10), bg="#007bff", fg="white")
